...
/**
 * The server smoke scenarios as NeoForge game tests (runSmokeServer), in the empty template
 * data/sophisticatedbuilding/structure/smoketest_empty.nbt.
...
public final class NeoForgeSmokeServerTests {
