...
/**
 * {@link SmokeBackpackScreens} against the GUI API of Sophisticated Backpacks 1.16.4 (its widget base class is
 * {@code Widget}, {@code BackpackWidget} in the 1.16.5 builds; before Sophisticated Core: the
...
public final class SophisticatedBackpacksScreens implements SmokeBackpackScreens {
    ...
    /** SettingsTabControl#getOpenTab is protected in Sophisticated Backpacks 1.16.4 (public in Sophisticated Core). */
