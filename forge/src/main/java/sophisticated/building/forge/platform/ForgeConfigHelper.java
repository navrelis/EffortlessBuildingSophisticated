...
public final class ForgeConfigHelper implements IConfigHelper {
    ...
    private static final class Builder implements IConfigBuilder {
        ...
        public ConfigValue<List<String>> defineList(String key, List<String> defaultValue) {
            ...
            return new ConfigValue<List<String>>() {
                @Override
    ...
    /**
     * A loader-neutral view of a ForgeConfigSpec value; set() changes the loaded config in memory. Forge 35/36's
     * ConfigValue has no getDefault(), so the default the value was defined with is kept here.
     */
