...
public final class ForgeConfigHelper implements IConfigHelper {
    ...
    /**
     * A loader-neutral view of a ForgeConfigSpec value; set() changes the loaded config in memory. Forge 34 values
     * do not know their default (ConfigValue#getDefault came later), so it is kept here.
     */
