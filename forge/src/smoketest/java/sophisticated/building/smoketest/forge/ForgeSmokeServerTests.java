...
/**
 * The server smoke scenarios as Forge game tests (runSmokeServer). No Sophisticated Backpacks on Forge 1.20.4, so no
 * sb_ tests.
...
public final class ForgeSmokeServerTests {
    ...
    @GameTest(template = "sophisticatedbuilding:smoketest_empty", batch = "smoke_limits", timeoutTicks = ServerScenarios.TIMEOUT_TICKS)
