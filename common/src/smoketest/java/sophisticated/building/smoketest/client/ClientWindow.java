...
final class ClientWindow {
     ...
     * {@code Minecraft#isWindowActive()} (26.1: {@code Window#isFocused()}) is false, and {@code releaseMouse} nothing
     * while the mouse is not grabbed. So:
    ...
    static String keepOffTheCursor(Minecraft mc) {
        ...
        // 26.1: Minecraft#isWindowActive() reads Window#isFocused() (the windowActive field of Minecraft is gone)
        setField(com.mojang.blaze3d.platform.Window.class, mc.getWindow(), "focused", false);
        ...
        if (Platform.get() == Platform.WINDOWS) {
            ...
            if (hwnd != 0) {
                ...
                // LWJGL 3.4: the first argument receives GetLastError (not needed here)
                User32.SetWindowLongPtr((IntBuffer) null, hwnd, User32.GWL_EXSTYLE, style | User32.WS_EX_NOACTIVATE);
