...
/**
 * {@link SmokeBackpackScreens} against the Sophisticated Backpacks GUI API of Minecraft 1.17.1: there is no
 * Sophisticated Core yet, the storage screen is {@link BackpackScreen}, the widgets
