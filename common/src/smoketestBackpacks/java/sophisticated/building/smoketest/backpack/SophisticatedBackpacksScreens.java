...
/**
 * {@link SmokeBackpackScreens} against the Sophisticated Core GUI API (same on the official NeoForge builds and the
 * Fabric port for 1.21.1): the storage screen's upgrade settings tab control holds one tab per upgrade; a tab's first
