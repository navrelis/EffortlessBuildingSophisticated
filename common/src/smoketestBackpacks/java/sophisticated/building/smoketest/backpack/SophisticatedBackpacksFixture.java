 ...
 * name of the inventory slot count, see slotCount); a port whose Sophisticated Backpacks API differs copies this class
 * into its loader's smoke source set and adapts it.
 */
