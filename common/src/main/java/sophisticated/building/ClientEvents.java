...
public class ClientEvents {
    ...
    public static void onKeyPress() {
        ...
        if (keyBindings[0].isDown()) {
            if (!AttachmentHandler.isDisabled(player)) {
                ...
                SophisticatedBuilding.log(player, new TranslatableComponent("sophisticatedbuilding.message.build_modes_disabled"));
            }
        }
    ...
    public static void openModifierSettings() {
        ...
        if (AttachmentHandler.isDisabled(player)) {
            SophisticatedBuilding.log(player, new TranslatableComponent("sophisticatedbuilding.message.build_modifiers_disabled"));
        } else {
