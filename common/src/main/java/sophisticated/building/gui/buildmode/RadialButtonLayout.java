...
public final class RadialButtonLayout {
    ...
    public static final class Cell {
        ...
        public Cell(int row, int column, double x, double y) {
            this.row = row;
            this.column = column;
            this.x = x;
            this.y = y;
    ...
    public static final class Result {
        ...
        private final double[] rowFirstY;

        public Result(List<Cell> cells, double inner, double[] rowFirstY) {
            this.cells = cells;
            this.inner = inner;
            this.rowFirstY = rowFirstY;
        }
    ...
    public static Result layout(boolean right, List<int[]> rows, double screenWidth, double screenHeight, double preferredInner,
        ...
        return new Result(Collections.unmodifiableList(new ArrayList<>(cells)), inner, rowFirstY);
    }
}
