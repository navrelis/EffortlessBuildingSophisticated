...
public class GoldenRandomizerBagContainer extends AbstractContainerMenu {
	...
	public GoldenRandomizerBagContainer(int containerId, Inventory playerInventory, IItemHandler inventory) {
		...
		for (int i = 0; i < GoldenRandomizerBagItem.INV_SIZE; ++i) {
			this.addSlot(new TemplateSlot(bagInventory, i, 8 + (18 * i), 20, GoldenRandomizerBagItem.INV_SIZE));
		}
	...
	public boolean stillValid(Player playerIn) {
		return playerIn.getMainHandItem().getItem() instanceof GoldenRandomizerBagItem
				|| playerIn.getOffhandItem().getItem() instanceof GoldenRandomizerBagItem;
	}
