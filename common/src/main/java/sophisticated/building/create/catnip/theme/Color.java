package sophisticated.building.create.catnip.theme;
...
/**
 * Adapted from Catnip ({@code sophisticated.building.create.catnip.theme.Color}, MIT License, Copyright (c) 2022
