package sophisticated.building.create.catnip.math;
...
/**
 * Adapted from Catnip ({@code sophisticated.building.create.catnip.math.AngleHelper}, MIT License, Copyright (c) 2022
