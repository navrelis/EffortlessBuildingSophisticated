...
/**
 * Adapted from Catnip ({@code sophisticated.building.create.catnip.outliner.AABBOutline}, MIT License, Copyright (c) 2022
...
public class AABBOutline extends Outline {
	...
	protected void renderBoxFace(PoseStack.Pose pose, SuperRenderTypeBuffer buffer, boolean cull, Direction highlightedFace, Vector3f minPos, Vector3f maxPos, Direction face, Vector4f color, int lightmap) {
		...
		RenderType renderType = OutlineRenderTypes.outlineTranslucent(faceTexture.getLocation(), cull);
