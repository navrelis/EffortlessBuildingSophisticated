...
/**
 * Adapted from Catnip ({@code sophisticated.building.create.catnip.outliner.Outline}, MIT License, Copyright (c) 2022
...
public abstract class Outline {
	...
	public void bufferCuboidLine(PoseStack poseStack, VertexConsumer consumer, Vec3 camera, Vec3 start, Vec3 end,
