...
public class TooltipHelper {
	...
	public static List<String> cutString(String s, ChatFormatting defaultColor, ChatFormatting highlightColor,
		...
		BreakIterator iterator = BreakIterator.getLineInstance(ClientServices.CLIENT.getLocale());
		...
		List<String> lines = wrapWords(font, markedUp, maxWidthPerLine);
	...
	// Hard word wrap, from Catnip's ClientFontHelper.cutString (MIT License, Copyright (c) 2022 The Create Team)
	private static List<String> wrapWords(Font font, String text, int maxWidthPerLine) {
		List<String> words = new LinkedList<>();
		BreakIterator iterator = BreakIterator.getLineInstance(ClientServices.CLIENT.getLocale());
