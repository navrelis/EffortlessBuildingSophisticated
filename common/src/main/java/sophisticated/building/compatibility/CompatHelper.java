...
public class CompatHelper {
	...
	public static boolean isCreateLoaded() {
		if (createLoaded == null) {
			createLoaded = Services.PLATFORM.isModLoaded("create");
		}
		return createLoaded;
	}
	...
	public static boolean isSophisticatedBackpacksLoaded() {
		...
		boolean loaded = Services.PLATFORM.isModLoaded("sophisticatedbackpacks");
	...
	public static boolean containsBlock(ItemStack stack, Block block) {
		...
		if (stack.getItem() instanceof AbstractRandomizerBagItem) {
			...
			IItemHandler bagInventory = randomizerBagItem.getBagInventory(stack);
			ItemStack match = ItemHelper.findFirstMatch(bagInventory, s -> s.getItem() instanceof BlockItem && ((BlockItem) s.getItem()).getBlock() == block);
