...
public class AllIcons implements ScreenElement, net.createmod.catnip.gui.element.ScreenElement {
	...
	@Environment(EnvType.CLIENT)
	public net.createmod.catnip.gui.element.DelegatedStencilElement asStencil() {
		return new net.createmod.catnip.gui.element.DelegatedStencilElement()
