...
/**
 * A simple RGBA color class that provides similar functionality to Catnip's Color.
 * This allows the mod to work standalone without requiring Create/Catnip as a dependency.
 * When Catnip is available, this can be converted to Catnip's Color for rendering.
 */
public class Color {
