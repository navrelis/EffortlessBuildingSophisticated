...
public enum BuildModeEnum {
    ...
    LINE("line", new Line(), BuildModeCategoryEnum.BASIC, AllIcons.I_LINE, ModeOptions.OptionEnum.LINE_THICKNESS),
    ...
    DIAGONAL_LINE("diagonal_line", new DiagonalLine(), BuildModeCategoryEnum.DIAGONAL, AllIcons.I_DIAGONAL_LINE, ModeOptions.OptionEnum.LINE_THICKNESS),
    DIAGONAL_WALL("diagonal_wall", new DiagonalWall(), BuildModeCategoryEnum.DIAGONAL, AllIcons.I_DIAGONAL_WALL, ModeOptions.OptionEnum.FILL),
