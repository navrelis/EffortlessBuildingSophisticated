...
public class PacketHandler {
	...
	public static void setupPackets(final RegisterPayloadHandlersEvent event) {
		...
		registrar.playToClient(BackpackToolsPacket.ID, BackpackToolsPacket.CODEC, BackpackToolsPacket.Handler::handle);
		registrar.playToClient(BreakCountdownPacket.ID, BreakCountdownPacket.CODEC, BreakCountdownPacket.Handler::handle);
	}
}
