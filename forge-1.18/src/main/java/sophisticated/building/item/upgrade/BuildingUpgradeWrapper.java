...
public class BuildingUpgradeWrapper extends UpgradeWrapperBase<BuildingUpgradeWrapper, BuildingUpgradeItem> {
    ...
    public BuildingUpgradeWrapper(IBackpackWrapper storageWrapper, ItemStack upgrade, Consumer<ItemStack> upgradeSaveHandler) {
     ...
     */
    public IBackpackWrapper getStorageWrapper() {
