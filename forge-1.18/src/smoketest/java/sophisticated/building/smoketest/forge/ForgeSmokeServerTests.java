...
/**
 * The server smoke scenarios as game tests (runSmokeServer), in the empty template
 * data/sophisticatedbuilding/structures/smoketest_empty.nbt. Forge 38 has no game test integration
 * ({@code @GameTestHolder} and the game test server are Forge 39+): {@link SmokeServerRunner} turns these methods into
 * vanilla test functions and runs them on the dedicated server.
