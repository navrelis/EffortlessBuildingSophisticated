 ...
 */
public class PlayerDataGameTest implements FabricGameTest {
    ...
    public void powerLevelAndDataSurviveARestart(GameTestHelper helper) {
        ...
        try {
            ...
            ServerPlayer restored = new ServerPlayer(helper.getLevel().getServer(), helper.getLevel(),
                    new GameProfile(UUID.randomUUID(), "sb-restored"), null);
            restored.load(saved);
    ...
    public void dataDoesNotLeakIntoANewPlayerObject(GameTestHelper helper) {
        ...
        try {
            ...
            ServerPlayer sameUuid = new ServerPlayer(helper.getLevel().getServer(), helper.getLevel(), player.getGameProfile(), null);
    ...
    public void dataSurvivesRespawn(GameTestHelper helper) {
        ...
        try {
            ...
            ServerPlayer respawned = new ServerPlayer(helper.getLevel().getServer(), helper.getLevel(), player.getGameProfile(), null);
