...
public class PlayerDataGameTest {
    ...
    public void powerLevelAndDataSurviveARestart(GameTestHelper helper) {
        ...
        try {
            ...
            //1.21.6+: players save into a ValueOutput and load from a ValueInput (tag backed, like the player data file)
            ...
            restored.load(TagValueInput.create(ProblemReporter.DISCARDING, restored.registryAccess(), saved));
