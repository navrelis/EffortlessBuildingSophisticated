...
public class PlayerDataGameTest {
    ...
    public void powerLevelAndDataSurviveARestart(GameTestHelper helper) {
        ...
        try {
            ...
            // Minecraft 1.21.6+ saves entities through ValueOutput / ValueInput (the player data file holds the resulting tag)
            ...
            restored.load(TagValueInput.create(ProblemReporter.DISCARDING, player.registryAccess(), saved));
