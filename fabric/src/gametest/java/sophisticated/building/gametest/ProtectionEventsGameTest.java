 ...
 * (a listener that cancels BEFORE keeps the block, AFTER follows every broken block). The Common Protection API of the
 * newer branches needs Java 17, which Minecraft 1.17.1 does not run on.
 */
