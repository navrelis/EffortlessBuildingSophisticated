...
public class ProtectionEventsGameTest implements FabricGameTest {
    ...
    private static synchronized void register() {
        ...
        CommonProtection.register(new ResourceLocation("sophisticatedbuilding_gametest", "refuse_place"), new ProtectionProvider() {
            @Override
    ...
    public void cancelledBreakEventKeepsTheBlock(GameTestHelper helper) {
        ...
        try (var config = ConfigScope.baseline()) {
            ...
            helper.assertTrue(!BROKEN_AFTER.contains(refused), "PlayerBlockBreakEvents.AFTER must not fire for the refused block");
        } finally {
