...
public class OffhandBagFilterGameTest implements FabricGameTest {
    ...
    public void bagFilterAcceptsOnlyItsBlocks(GameTestHelper helper) {
        ...
        helper.assertTrue(!CompatHelper.containsBlock(bag, Blocks.DIRT), "Dirt is not in the bag and should not be accepted");
        helper.assertTrue(!CompatHelper.containsBlock(bag, Blocks.AIR), "Air is not in the bag and should not be accepted");
        helper.succeed();
    }
}
