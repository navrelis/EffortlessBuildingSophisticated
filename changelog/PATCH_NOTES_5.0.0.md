# Sophisticated Building Update – 5.0.0 (Minecraft 1.20.4)

## Artifacts

* `sophisticatedbuilding-fabric-1.20.4-5.0.0.jar` — Fabric
* `sophisticatedbuilding-neoforge-1.20.4-5.0.0.jar` — NeoForge
* `sophisticatedbuilding-forge-1.20.4-5.0.0.jar` — Forge
