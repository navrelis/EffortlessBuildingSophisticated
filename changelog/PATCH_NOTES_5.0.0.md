# Sophisticated Building Update – 5.0.0 (Minecraft 1.17.1)

## Artifacts

* `sophisticatedbuilding-fabric-1.17.1-5.0.0.jar` — Fabric
* `sophisticatedbuilding-forge-1.17.1-5.0.0.jar` — Forge
