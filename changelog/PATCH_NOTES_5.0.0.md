# Sophisticated Building Update – 5.0.0 (Minecraft 1.19.4)

## Artifacts

* `sophisticatedbuilding-fabric-1.19.4-5.0.0.jar` — Fabric, Minecraft 1.19.4
* `sophisticatedbuilding-forge-1.19.4-5.0.0.jar` — Forge, Minecraft 1.19.4
