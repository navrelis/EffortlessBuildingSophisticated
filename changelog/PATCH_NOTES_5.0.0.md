# Sophisticated Building Update – 5.0.0 (Minecraft 1.18.2)

## Artifacts

* `sophisticatedbuilding-fabric-1.18.2-5.0.0.jar` — Fabric
* `sophisticatedbuilding-forge-1.18.2-5.0.0.jar` — Forge
