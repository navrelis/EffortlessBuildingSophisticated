# Sophisticated Building Update – 5.0.0 (Minecraft 1.21.4)

## Artifacts

* `sophisticatedbuilding-fabric-1.21.4-5.0.0.jar` — Fabric
* `sophisticatedbuilding-neoforge-1.21.4-5.0.0.jar` — NeoForge
* `sophisticatedbuilding-forge-1.21.4-5.0.0.jar` — Forge

## New

### Minecraft 1.21.4

Sophisticated Building 5.0.0 is the first release for Minecraft 1.21.4, on Fabric, NeoForge and
