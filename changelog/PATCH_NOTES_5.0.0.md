# Sophisticated Building Update – 5.0.0 (Minecraft 1.20.1)

## Artifacts

* `sophisticatedbuilding-fabric-1.20.1-5.0.0.jar` — Fabric
* `sophisticatedbuilding-forge-1.20.1-5.0.0.jar` — Forge (also runs on NeoForge 1.20.1)
