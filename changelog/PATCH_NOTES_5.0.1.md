# Sophisticated Building Update – 5.0.1 - Minecraft 1.17.1

## Artifacts

* `sophisticatedbuilding-fabric-1.17.1-5.0.1.jar` — Fabric, Minecraft 1.17.1
* `sophisticatedbuilding-forge-1.17.1-5.0.1.jar` — Forge, Minecraft 1.17.1
...
* **Fabric, claim and protection mods:** the mod's breaks now fire Fabric API's player block break events, so claim
  mods that listen to them can cancel them. (The Common Protection API, which newer versions of the mod also ask,
  needs Java 17 and is not available for Minecraft 1.17.1.)
