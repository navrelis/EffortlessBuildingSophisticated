# Sophisticated Building Update – 5.0.1 - Minecraft 1.20.1

A bug-fix release for 1.20.1: nothing to migrate, worlds and configs of 5.0.0 load unchanged.

## Artifacts

* `sophisticatedbuilding-fabric-1.20.1-5.0.1.jar` — Fabric
* `sophisticatedbuilding-forge-1.20.1-5.0.1.jar` — Forge (also runs on NeoForge 1.20.1)
