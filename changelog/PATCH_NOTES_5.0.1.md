# Sophisticated Building Update – 5.0.1 - Minecraft 1.18.1 and 1.18

## Artifacts

* `sophisticatedbuilding-fabric-1.18.1-5.0.1.jar` — Fabric, Minecraft 1.18 and 1.18.1
* `sophisticatedbuilding-forge-1.18.1-5.0.1.jar` — Forge, Minecraft 1.18.1
* `sophisticatedbuilding-forge-1.18-5.0.1.jar` — Forge, Minecraft 1.18
