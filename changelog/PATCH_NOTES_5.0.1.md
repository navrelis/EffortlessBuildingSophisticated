# Sophisticated Building Update – 5.0.1 - Minecraft 1.20.4

A bug-fix release for 1.20.4: nothing to migrate, worlds and configs of 5.0.0 load unchanged.

## Artifacts

* `sophisticatedbuilding-fabric-1.20.4-5.0.1.jar` — Fabric
* `sophisticatedbuilding-neoforge-1.20.4-5.0.1.jar` — NeoForge
* `sophisticatedbuilding-forge-1.20.4-5.0.1.jar` — Forge
