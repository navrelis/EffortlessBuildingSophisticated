# Sophisticated Building Update – 5.0.1 - Minecraft 1.19 - 1.19.2

A bug-fix release for 1.19 - 1.19.2: nothing to migrate, worlds and configs of 5.0.0 load unchanged.

## Artifacts

* `sophisticatedbuilding-fabric-1.19.2-5.0.1.jar` — Fabric, Minecraft 1.19, 1.19.1 and 1.19.2
* `sophisticatedbuilding-forge-1.19.2-5.0.1.jar` — Forge, Minecraft 1.19.2
* `sophisticatedbuilding-forge-1.19-5.0.1.jar` — Forge, Minecraft 1.19 and 1.19.1
...
* **Fabric: player data kept in the world save:** the power level and the mod's per-player data (modifier settings,
  ...
  world into the next. They are now saved with the player, like on the other loaders, and follow the player on
  respawn.
