...
This branch (`mc/1.21.1`) holds Sophisticated Building for Minecraft 1.21.1 on Fabric and NeoForge. It is the
...
Each loader folder has its own Gradle wrapper (Fabric: Gradle 8.12.1, NeoForge: Gradle 9.2.0). Java 21.
