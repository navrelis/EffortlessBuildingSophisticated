...
`forge-1.18/` builds `sophisticatedbuilding-forge-1.18-5.0.1.jar` (Minecraft `[1.18]`, Forge `[38.0.17,)`,
...
cd forge-1.18 && ./gradlew build      # the Forge 1.18 jar in forge-1.18/build/libs, same unit tests (103)
